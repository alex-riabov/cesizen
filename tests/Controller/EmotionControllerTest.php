...
final class EmotionControllerTest extends WebTestCase{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'emotion[nomEmotion]' => 'Testing',
            'emotion[emotionBase]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        $this->markTestIncomplete();
        $fixture = new Emotion();
        $fixture->setNomEmotion('My Title');
        $fixture->setEmotionBase('My Title');
    ...
    public function testEdit(): void
    {
        $this->markTestIncomplete();
        $fixture = new Emotion();
        $fixture->setNomEmotion('Value');
        $fixture->setEmotionBase('Value');
        ...
        $this->client->submitForm('Update', [
            'emotion[nomEmotion]' => 'Something New',
            'emotion[emotionBase]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getNomEmotion());
        self::assertSame('Something New', $fixture[0]->getEmotionBase());
    }
